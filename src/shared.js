...
const shared = {
  ...
  'user-login': {
    text: (
      <>
        On the npm "<Link href="https://www.npmjs.com/login">Sign In</Link>" page, enter your account details and click{' '}
  ...
  'profile-settings': {
    text: (
      <>
        In the upper right corner of the page, click your profile picture, then click <strong>Profile Settings</strong>.
      </>
    ),
    image: (
      <Screenshot src="/shared/profile-settings.png" alt="Screenshot of profile settings selection in user menu" />
    ),
  },
  'account-settings': {
    text: (
      <>
        In the upper right corner of the page, click your profile picture, then click <strong>Account</strong>.
      </>
    ),
    image: (
      <Screenshot src="/shared/account-settings.png" alt="Screenshot of account settings selection in user menu" />
    ),
  },
  'start-account-recovery': {
    text: (
      <>
        On the "Request an Account Recovery" page, click <strong>Start Account Recovery</strong>.
      </>
    ),
    image: (
      <Screenshot
        src="/getting-started/setting-up-your-npm-user-account/request-account-recovery.png"
        alt="Screenshot showing account recovery page"
      />
    ),
  },
  'use-recovery-code': {
    text: (
      <>
        On the "Two-Factor Authentication" page, click <strong>Use a recovery code or request a reset</strong>.
      </>
    ),
    image: (
      <Screenshot
        src="/getting-started/setting-up-your-npm-user-account/recovery-code-link.png"
        alt="Screenshot showing Security Key prompt with a link to navigate to the recovery code input screen"
      />
    ),
  },
  'support-ticket-form': {
  ...
  'enter-email-address': {
    text: (
      <>
        In the <strong>Email</strong> field, enter an email address where our support team can contact you.
      </>
    ),
  },
  'support-ticket-other': {
    text: (
      <>
        If you need help with anything else, in the <strong>How can we help?</strong> section, select{' '}
        <strong>Other</strong> and enter more information in the <strong>Additional Details</strong> field.
      </>
    ),
  },
  'connect-to-accounts': {
  ...
  'submit-support-ticket': {
    text: (
      <>
        At the bottom of the form, click <strong>Submit Support Ticket</strong>.
      </>
    ),
  },
  ...
  'billing-downgrade-selection': {
    text: (
      <>
        Under "change plan", click <strong>Downgrade Plan</strong>.
      </>
    ),
  ...
  'billing-downgrade-confirm': {
    text: (
      <>
        Under "Are you sure?", click <strong>Downgrade to a free account</strong>.
      </>
    ),
    image: (
      <Screenshot src="/shared/billing-downgrade-confirm.png" alt="Screenshot of the downgrade plan confirmation" />
    ),
  },
  'billing-download': {
    text: (
      <>
        To download a single receipt, find the row of the receipt you want to download, then click the PDF icon on the
  ...
  'billing-download-checked': {
    text: (
      <>
        To download multiple receipts, first select the receipts that you wish to download by selecting the box next to
        the date. To select all receipts, select the checkbox next to the "Date" header. Then click{' '}
        <strong>Download Checked</strong>.
      </>
    ),
  ...
  'billing-email': {
    text: (
      <>
        To email a single receipt, find the row of the receipt you want to download, then, on the right side of the row,
  ...
  'billing-email-checked': {
    text: (
      <>
        To email multiple receipts, first select the receipts that you wish to download by selecting the box next to the
        date. To select all receipts, select the checkbox next to the "Date" header. Then click{' '}
        <strong>Email Checked</strong>.
      </>
    ),
  ...
  'billing-extra-info': {
    text: (
      <>
        To add a business name, VAT number, address of record, or other information to your receipts, in the "Extra
        Billing Information" text box, type the information.
      </>
    ),
  ...
  'billing-extra-receipt-email': {
    text: (
      <>
        To update the email address used for receipts, beside "Send my receipts", select the checkbox and type the email
        address that should receive billing receipts.
      </>
    ),
    image: (
      <Screenshot src="/shared/billing-extra-receipt-email.png" alt="Screenshot of billing receipt email settings" />
    ),
  },
  'billing-extra-save': {
    text: (
  ...
  'billing-history': {
    text: (
      <>
        On the Billing Information page, under "monthly bill", select <strong>View Billing History</strong>.
      </>
    ),
  ...
  'billing-info': {
    text: (
      <>
        In the upper right corner of the page, click your profile picture, then select <strong>Billing Info</strong>.
      </>
    ),
  ...
  'billing-update-card': {
    text: (
      <>
        Click <strong>Update Card</strong>.
      </>
    ),
    image: (
      <Screenshot src="/shared/billing-update-card.png" alt="Screenshot of update credit card confirmation button" />
    ),
  },
  'billing-view': {
    text: (
      <>
        To view a single receipt, find the row of the receipt you want to view, then, on the right side of the row,
        click the view icon.
      </>
    ),
  ...
  'payment-info-button': {
    text: (
      <>
        Click <strong>Payment Info</strong>.
      </>
    ),
  ...
  'payment-info': {
    text: (
      <>
        Under "monthly bill", click <strong>Edit Payment Info</strong>.
      </>
    ),
  ...
  'billing-organization-plans': {
    image: (
      <Screenshot src="/shared/billing-plan-selection.png" alt="Screenshot showing the billing plan selection dialog" />
    ),
  },
  ...
  'organization-package-private': {
    image: (
      <Screenshot src="/shared/organization-package-private.png" alt="Screenshot of a private npm Teams package" />
    ),
  },
  ...
  'organization-create': {
    text: (
      <>
        ...
        <strong>Add an Organization</strong>.
      </>
    ),
    image: (
      <Screenshot src="/shared/organization-create.png" alt="Screenshot of the add an organization dropdown menu" />
    ),
  },
  ...
  'organization-billing-tab': {
    text: (
      <>
        On the organization settings page, click <strong>Billing</strong>.
      </>
    ),
  ...
  'organization-members-tab': {
    text: (
      <>
        On the organization settings page, click <strong>Members</strong>.
      </>
    ),
  ...
  'organization-teams-tab': {
    text: (
      <>
        On the organization settings page, click <strong>Teams</strong>.
      </>
    ),
