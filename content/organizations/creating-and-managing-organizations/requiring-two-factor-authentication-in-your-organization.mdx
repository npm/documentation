...
Before you can require organization members to use two-favtor authentication, you must enable two-factor authnetication for your account on npm. For more information, see ["Configuring two-factor authentication."][configure-2fa].

Before you require use of two-factor authentication, we recommend notifying organization members and asking them to set up 2FA for their accounts. You can if members already use 2Fa in the organizations members page.
