---https://curl  -X GET -H "Authorization: token $GITHUB_PAT_TOKEN"   -H "Accept: application/vnd.github.v3+json"   https://api.github.com/user curl  -X GET -H "Authorization: token $GITHUB_OAUTH_TOKEN"   -H "Accept: application/vnd.github.v3+json"   https://api.github.com/user
