...
You can also run `npm install blerg` to install the latest version of "blerg". Check out [`npm install`](/cli/v10/commands/npm-install) for more info. It can do a lot of stuff.
