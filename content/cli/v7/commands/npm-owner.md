...
If you have two-factor authentication enabled with `auth-and-writes` (see [`npm-profile`](/cli/v7/commands/npm-profile)) then you'll need to include an otp on the command line when changing ownership with `--otp`.
