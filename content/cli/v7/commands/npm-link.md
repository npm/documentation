...
The package name can be optionally prefixed with a scope. See [`scope`](/cli/v7/using-npm/scope). The scope must be preceded by an @-symbol and followed by a slash.
