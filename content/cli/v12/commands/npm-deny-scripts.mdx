...
github_path: docs/lib/content/commands/npm-deny-scripts.md
redirect_from:
  - /cli-commands/deny-scripts
  - /cli-commands/npm-deny-scripts
  - /cli-documentation/cli-commands/deny-scripts
  - /cli-documentation/cli-commands/npm-deny-scripts
  - /cli-documentation/commands/deny-scripts
  - /cli-documentation/commands/npm-deny-scripts
  - /cli-documentation/deny-scripts
  - /cli-documentation/npm-deny-scripts
  - /cli-documentation/v12/cli-commands/deny-scripts
  - /cli-documentation/v12/cli-commands/npm-deny-scripts
  - /cli-documentation/v12/commands/deny-scripts
  - /cli-documentation/v12/commands/npm-deny-scripts
  - /cli-documentation/v12/deny-scripts
  - /cli-documentation/v12/npm-deny-scripts
  - /cli/cli-commands/deny-scripts
  - /cli/cli-commands/npm-deny-scripts
  - /cli/commands/deny-scripts
  - /cli/commands/npm-deny-scripts
  - /cli/deny-scripts
  - /cli/npm-deny-scripts
  - /cli/v12/cli-commands/deny-scripts
  - /cli/v12/cli-commands/npm-deny-scripts
  - /cli/v12/commands/deny-scripts
  - /cli/v12/deny-scripts
  - /cli/v12/npm-deny-scripts
  - /commands/deny-scripts
  - /commands/npm-deny-scripts
---
...
The companion command to [`npm approve-scripts`](/cli/v12/commands/npm-approve-scripts). Writes `false` entries into the `allowScripts` field of your project's `package.json`, recording that a dependency must not run install scripts even if a future version would otherwise be eligible.
