...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/npm-owner
  - /cli-documentation/v12/cli-commands/owner
  - /cli-documentation/v12/commands/npm-owner
  - /cli-documentation/v12/commands/owner
  - /cli-documentation/v12/npm-owner
  - /cli-documentation/v12/owner
  ...
  - /cli/npm-owner
  - /cli/owner
  - /cli/v12/cli-commands/npm-owner
  - /cli/v12/cli-commands/owner
  - /cli/v12/commands/owner
  - /cli/v12/npm-owner
  - /cli/v12/owner
  - /commands/npm-owner
  - /commands/owner
...
If you have two-factor authentication enabled with `auth-and-writes` (see [`npm-profile`](/cli/v12/commands/npm-profile)) then you'll need to go through a second factor flow when changing ownership or include an otp on the command line with `--otp`.
