...
github_path: docs/lib/content/commands/npm-approve-scripts.md
redirect_from:
  - /cli-commands/approve-scripts
  - /cli-commands/npm-approve-scripts
  - /cli-documentation/approve-scripts
  - /cli-documentation/cli-commands/approve-scripts
  - /cli-documentation/cli-commands/npm-approve-scripts
  - /cli-documentation/commands/approve-scripts
  - /cli-documentation/commands/npm-approve-scripts
  - /cli-documentation/npm-approve-scripts
  - /cli-documentation/v12/approve-scripts
  - /cli-documentation/v12/cli-commands/approve-scripts
  - /cli-documentation/v12/cli-commands/npm-approve-scripts
  - /cli-documentation/v12/commands/approve-scripts
  - /cli-documentation/v12/commands/npm-approve-scripts
  - /cli-documentation/v12/npm-approve-scripts
  - /cli/approve-scripts
  - /cli/cli-commands/approve-scripts
  - /cli/cli-commands/npm-approve-scripts
  - /cli/commands/approve-scripts
  - /cli/commands/npm-approve-scripts
  - /cli/npm-approve-scripts
  - /cli/v12/approve-scripts
  - /cli/v12/cli-commands/approve-scripts
  - /cli/v12/cli-commands/npm-approve-scripts
  - /cli/v12/commands/approve-scripts
  - /cli/v12/npm-approve-scripts
  - /commands/approve-scripts
  - /commands/npm-approve-scripts
---
...
Dependency install scripts are blocked by default. Install commands silently skip lifecycle scripts for any dependency that does not have a matching entry in `allowScripts`, and end with a list of the packages whose scripts were skipped so you can review them with this command.
...
- [npm deny-scripts](/cli/v12/commands/npm-deny-scripts)
