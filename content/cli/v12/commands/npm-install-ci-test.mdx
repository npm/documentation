...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/install-ci-test
  - /cli-documentation/v12/cli-commands/npm-install-ci-test
  - /cli-documentation/v12/commands/install-ci-test
  - /cli-documentation/v12/commands/npm-install-ci-test
  - /cli-documentation/v12/install-ci-test
  - /cli-documentation/v12/npm-install-ci-test
  ...
  - /cli/v12/cli-commands/install-ci-test
  - /cli/v12/cli-commands/npm-install-ci-test
  - /cli/v12/commands/install-ci-test
  - /cli/v12/install-ci-test
  - /cli/v12/npm-install-ci-test
...
- [npm install-test](/cli/v12/commands/npm-install-test)
- [npm ci](/cli/v12/commands/npm-ci)
