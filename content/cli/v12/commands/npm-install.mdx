...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/install
  - /cli-documentation/v12/cli-commands/npm-install
  - /cli-documentation/v12/commands/install
  - /cli-documentation/v12/commands/npm-install
  - /cli-documentation/v12/install
  - /cli-documentation/v12/npm-install
  ...
  - /cli/install
  - /cli/npm-install
  - /cli/v12/cli-commands/install
  - /cli/v12/cli-commands/npm-install
  - /cli/v12/commands/install
  - /cli/v12/install
  - /cli/v12/npm-install
  - /commands/install
...
See [package-lock.json](/cli/v12/configuring-npm/package-lock-json).
...
If you want to install packages while ensuring that `package.json` is not modified and that both files are strictly in sync, use [`npm ci`](/cli/v12/commands/npm-ci) instead.

A `package` is:

- a) a folder containing a program described by a [`package.json`](/cli/v12/configuring-npm/package-json) file
- b) a gzipped tarball containing (a)
- c) a url that resolves to (b)
- d) a `<name>@<version>` that is published on the registry (see [`registry`](/cli/v12/using-npm/registry)) with (c)
- e) a `<name>@<tag>` (see [`npm dist-tag`](/cli/v12/commands/npm-dist-tag)) that points to (d)
...
- `npm install` (in a package directory, no arguments):
  ...
  By default, `npm install` will install all modules listed as dependencies in [`package.json`](/cli/v12/configuring-npm/package-json).
...
- `npm install <tarball file>`:
  ...
  Install a package that is sitting on the filesystem. Note: if you just want to link a dev directory into your npm root, you can do this more easily by using [`npm link`](/cli/v12/commands/npm-link).
...
- `npm install [<@scope>/]<name>`:
  ...
  Do a `<name>@<tag>` install, where `<tag>` is the "tag" config. (See [`config`](/cli/v12/using-npm/config#tag). The config's default value is `latest`.)
  ...
  **Note:** When installing by name without specifying a version or tag, npm prioritizes versions that match the current Node.js version based on the package's `engines` field. If the `latest` tag points to a version incompatible with your current Node.js version, npm will install the newest compatible version instead. To install a specific version regardless of `engines` compatibility, explicitly specify the version or tag: `npm install <name>@latest`.
  ...
  `<scope>` is optional. The package will be downloaded from the registry associated with the specified scope. If no registry is associated with the given scope the default registry is assumed. See [`scope`](/cli/v12/using-npm/scope).
...
- `npm install [<@scope>/]<name>@<version range>`:
  ...
  Install a version of the package matching the specified version range. This will follow the same rules for resolving dependencies described in [`package.json`](/cli/v12/configuring-npm/package-json).
...
See the [`config`](/cli/v12/using-npm/config) help doc. Many of the configuration params have some effect on installation, since that's most of what npm does.
...
See [folders](/cli/v12/configuring-npm/folders) for a more detailed description of the specific folder structures that npm creates.

### See Also

- [npm folders](/cli/v12/configuring-npm/folders)
- [npm update](/cli/v12/commands/npm-update)
- [npm audit](/cli/v12/commands/npm-audit)
- [npm fund](/cli/v12/commands/npm-fund)
- [npm link](/cli/v12/commands/npm-link)
- [npm rebuild](/cli/v12/commands/npm-rebuild)
- [npm scripts](/cli/v12/using-npm/scripts)
- [npm config](/cli/v12/commands/npm-config)
- [npmrc](/cli/v12/configuring-npm/npmrc)
- [npm registry](/cli/v12/using-npm/registry)
- [npm dist-tag](/cli/v12/commands/npm-dist-tag)
- [npm uninstall](/cli/v12/commands/npm-uninstall)
- [package.json](/cli/v12/configuring-npm/package-json)
- [workspaces](/cli/v12/using-npm/workspaces)
