...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/npm-update
  - /cli-documentation/v12/cli-commands/update
  - /cli-documentation/v12/commands/npm-update
  - /cli-documentation/v12/commands/update
  - /cli-documentation/v12/npm-update
  - /cli-documentation/v12/update
  ...
  - /cli/npm-update
  - /cli/update
  - /cli/v12/cli-commands/npm-update
  - /cli/v12/cli-commands/update
  - /cli/v12/commands/update
  - /cli/v12/npm-update
  - /cli/v12/update
  - /commands/npm-update
  - /commands/update
...
This command will update all the packages listed to the latest version (specified by the [`tag` config](/cli/v12/using-npm/config#tag)), respecting the semver constraints of both your package and its dependencies (if they also require the same package).
...
Note that by default `npm update` will not update the semver values of direct dependencies in your project `package.json`. If you want to also update values in `package.json` you can run: `npm update --save` (or add the `save=true` option to a [configuration file](/cli/v12/configuring-npm/npmrc) to make that the default behavior).
