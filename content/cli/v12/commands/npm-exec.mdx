...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/exec
  - /cli-documentation/v12/cli-commands/npm-exec
  - /cli-documentation/v12/commands/exec
  - /cli-documentation/v12/commands/npm-exec
  - /cli-documentation/v12/exec
  - /cli-documentation/v12/npm-exec
  ...
  - /cli/exec
  - /cli/npm-exec
  - /cli/v12/cli-commands/exec
  - /cli/v12/cli-commands/npm-exec
  - /cli/v12/commands/exec
  - /cli/v12/exec
  - /cli/v12/npm-exec
  - /commands/exec
  - /commands/npm-exec
...
You can execute an arbitrary command from a package in the context of each of the configured workspaces when using the [`workspaces` config options](/cli/v12/using-npm/config#workspace), in this example we're using **eslint** to lint any js file found within each workspace folder:
...
The npm cli utilizes its internal package cache when using the package name specified. You can use the following to change how and when the cli uses this cache. See [`npm cache`](/cli/v12/commands/npm-cache) for more on how the cache works.
...
- [npm workspaces](/cli/v12/using-npm/workspaces)
- [npx](/cli/v12/commands/npx)
