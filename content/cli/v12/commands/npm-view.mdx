...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/npm-view
  - /cli-documentation/v12/cli-commands/view
  - /cli-documentation/v12/commands/npm-view
  - /cli-documentation/v12/commands/view
  - /cli-documentation/v12/npm-view
  - /cli-documentation/v12/view
  ...
  - /cli/commands/view
  - /cli/npm-view
  - /cli/v12/cli-commands/npm-view
  - /cli/v12/cli-commands/view
  - /cli/v12/commands/view
  - /cli/v12/npm-view
  - /cli/v12/view
  - /cli/view
  - /commands/npm-view
...
"Person" fields are shown as a string if they would be shown as an object. So, for example, this will show the list of `npm` contributors in the shortened string format. (See [`package.json`](/cli/v12/configuring-npm/package-json) for more on this.)
...
If the `--json` flag is given, the outputted fields will be JSON. Scalar and object results are returned in an array, even if only a single version matches. When the output contains one array-valued result, that array is returned directly without an additional result wrapper. Multiple array-valued results remain separate items in the outer results array.
