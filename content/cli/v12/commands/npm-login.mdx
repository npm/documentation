...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/login
  - /cli-documentation/v12/cli-commands/npm-login
  - /cli-documentation/v12/commands/login
  - /cli-documentation/v12/commands/npm-login
  - /cli-documentation/v12/login
  - /cli-documentation/v12/npm-login
  ...
  - /cli/login
  - /cli/npm-login
  - /cli/v12/cli-commands/login
  - /cli/v12/cli-commands/npm-login
  - /cli/v12/commands/login
  - /cli/v12/login
  - /cli/v12/npm-login
  - /commands/login
  - /commands/npm-login
...
Verify a user in the specified registry, and save the credentials to the `.npmrc` file. If no registry is specified, the default registry will be used (see [`config`](/cli/v12/using-npm/config)).
