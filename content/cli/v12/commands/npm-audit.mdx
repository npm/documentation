...
redirect_from:
  ...
  - /cli-documentation/v12/audit
  - /cli-documentation/v12/cli-commands/audit
  - /cli-documentation/v12/cli-commands/npm-audit
  - /cli-documentation/v12/commands/audit
  - /cli-documentation/v12/commands/npm-audit
  - /cli-documentation/v12/npm-audit
  - /cli/audit
  ...
  - /cli/npm-audit
  - /cli/v12/audit
  - /cli/v12/cli-commands/audit
  - /cli/v12/cli-commands/npm-audit
  - /cli/v12/commands/audit
  - /cli/v12/npm-audit
  - /commands/audit
  - /commands/npm-audit
---
...
By default npm requires a package-lock in order to run the audit. You can bypass the package lock with `--no-package-lock` but be aware the results may be different with every run, since npm will re-build the dependency tree each time.
...
If vulnerabilities were found the exit code will depend on the [`audit-level` config](/cli/v12/using-npm/config#audit-level).
