...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/init
  - /cli-documentation/v12/cli-commands/npm-init
  - /cli-documentation/v12/commands/init
  - /cli-documentation/v12/commands/npm-init
  - /cli-documentation/v12/init
  - /cli-documentation/v12/npm-init
  ...
  - /cli/init
  - /cli/npm-init
  - /cli/v12/cli-commands/init
  - /cli/v12/cli-commands/npm-init
  - /cli/v12/commands/init
  - /cli/v12/init
  - /cli/v12/npm-init
  - /commands/init
  - /commands/npm-init
...
`initializer` in this case is an npm package named `create-<initializer>`, which will be installed by [`npm-exec`](/cli/v12/commands/npm-exec), and then have its main bin executed -- presumably creating or updating `package.json` and running any other initialization-related operations.
...
- [npm exec](/cli/v12/commands/npm-exec)
