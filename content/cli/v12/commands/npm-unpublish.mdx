...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/npm-unpublish
  - /cli-documentation/v12/cli-commands/unpublish
  - /cli-documentation/v12/commands/npm-unpublish
  - /cli-documentation/v12/commands/unpublish
  - /cli-documentation/v12/npm-unpublish
  - /cli-documentation/v12/unpublish
  ...
  - /cli/npm-unpublish
  - /cli/unpublish
  - /cli/v12/cli-commands/npm-unpublish
  - /cli/v12/cli-commands/unpublish
  - /cli/v12/commands/unpublish
  - /cli/v12/npm-unpublish
  - /cli/v12/unpublish
...
Consider using the [`deprecate`](/cli/v12/commands/npm-deprecate) command instead, if your intent is to encourage users to upgrade, or if you no longer want to maintain a package.

### Description

This removes a package version from the registry, deleting its entry and removing the tarball.

The npm registry will return an error if you are not [logged in](/cli/v12/commands/npm-login).
