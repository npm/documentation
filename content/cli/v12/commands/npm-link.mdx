...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/link
  - /cli-documentation/v12/cli-commands/npm-link
  - /cli-documentation/v12/commands/link
  - /cli-documentation/v12/commands/npm-link
  - /cli-documentation/v12/link
  - /cli-documentation/v12/npm-link
  ...
  - /cli/link
  - /cli/npm-link
  - /cli/v12/cli-commands/link
  - /cli/v12/cli-commands/npm-link
  - /cli/v12/commands/link
  - /cli/v12/link
  - /cli/v12/npm-link
  - /commands/link
  - /commands/npm-link
...
The package name can be optionally prefixed with a scope. See [`scope`](/cli/v12/using-npm/scope). The scope must be preceded by an @-symbol and followed by a slash.
...
If your linked package is scoped (see [`scope`](/cli/v12/using-npm/scope)) your link command must include that scope, e.g.
...
- [package spec](/cli/v12/using-npm/package-spec)
- [npm developers](/cli/v12/using-npm/developers)
