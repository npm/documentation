...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/npm-publish
  - /cli-documentation/v12/cli-commands/publish
  - /cli-documentation/v12/commands/npm-publish
  - /cli-documentation/v12/commands/publish
  - /cli-documentation/v12/npm-publish
  - /cli-documentation/v12/publish
  ...
  - /cli/npm-publish
  - /cli/publish
  - /cli/v12/cli-commands/npm-publish
  - /cli/v12/cli-commands/publish
  - /cli/v12/commands/publish
  - /cli/v12/npm-publish
  - /cli/v12/publish
...
By default npm will publish to the public registry. This can be overridden by specifying a different default registry or using a [`scope`](/cli/v12/using-npm/scope) in the name, combined with a scope-configured registry (see [`package.json`](/cli/v12/configuring-npm/package-json)).
...
Once a package is published with a given name and version, that specific name and version combination can never be used again, even if it is removed with [`npm unpublish`](/cli/v12/commands/npm-unpublish).
...
Similar to `--dry-run` see [`npm pack`](/cli/v12/commands/npm-pack), which figures out the files to be included and packs them into a tarball to be uploaded to the registry.
...
- If there is a "files" list in [`package.json`](/cli/v12/configuring-npm/package-json), then only the files specified will be included. (If directories are specified, then they will be walked recursively and their contents included, subject to the same ignore rules.)
...
See [`developers`](/cli/v12/using-npm/developers) for full details on what's included in the published package, as well as details on how the package is built.

See [`package.json`](/cli/v12/configuring-npm/package-json) for more info on what can and can't be ignored.
...
- [npm scope](/cli/v12/using-npm/scope)
- [npm login](/cli/v12/commands/npm-login)
- [npm owner](/cli/v12/commands/npm-owner)
- [npm deprecate](/cli/v12/commands/npm-deprecate)
- [npm dist-tag](/cli/v12/commands/npm-dist-tag)
- [npm pack](/cli/v12/commands/npm-pack)
- [npm profile](/cli/v12/commands/npm-profile)
