...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/install-test
  - /cli-documentation/v12/cli-commands/npm-install-test
  - /cli-documentation/v12/commands/install-test
  - /cli-documentation/v12/commands/npm-install-test
  - /cli-documentation/v12/install-test
  - /cli-documentation/v12/npm-install-test
  ...
  - /cli/v12/cli-commands/install-test
  - /cli/v12/cli-commands/npm-install-test
  - /cli/v12/commands/install-test
  - /cli/v12/install-test
  - /cli/v12/npm-install-test
...
- [npm install-ci-test](/cli/v12/commands/npm-install-ci-test)
