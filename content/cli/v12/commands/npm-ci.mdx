...
redirect_from:
  ...
  - /cli-documentation/v12/ci
  - /cli-documentation/v12/cli-commands/ci
  - /cli-documentation/v12/cli-commands/npm-ci
  - /cli-documentation/v12/commands/ci
  - /cli-documentation/v12/commands/npm-ci
  - /cli-documentation/v12/npm-ci
  - /cli/ci
  - /cli/cli-commands/ci
  ...
  - /cli/npm-ci
  - /cli/v12/ci
  - /cli/v12/cli-commands/ci
  - /cli/v12/cli-commands/npm-ci
  - /cli/v12/commands/ci
  - /cli/v12/npm-ci
  - /commands/ci
  - /commands/npm-ci
...
This command is similar to [`npm install`](/cli/v12/commands/npm-install), except it's meant to be used in automated environments such as test platforms, continuous integration, and deployment -- or any situation where you want to make sure you're doing a clean install of your dependencies.
...
- It will never write to `package.json` or `package-lock.json`: installs are essentially frozen.
...
- [package-lock.json](/cli/v12/configuring-npm/package-lock-json)
