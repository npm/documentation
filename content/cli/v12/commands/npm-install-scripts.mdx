...
github_path: docs/lib/content/commands/npm-install-scripts.md
redirect_from:
  - /cli-commands/install-scripts
  - /cli-commands/npm-install-scripts
  - /cli-documentation/cli-commands/install-scripts
  - /cli-documentation/cli-commands/npm-install-scripts
  - /cli-documentation/commands/install-scripts
  - /cli-documentation/commands/npm-install-scripts
  - /cli-documentation/install-scripts
  - /cli-documentation/npm-install-scripts
  - /cli-documentation/v12/cli-commands/install-scripts
  - /cli-documentation/v12/cli-commands/npm-install-scripts
  - /cli-documentation/v12/commands/install-scripts
  - /cli-documentation/v12/commands/npm-install-scripts
  - /cli-documentation/v12/install-scripts
  - /cli-documentation/v12/npm-install-scripts
  - /cli/cli-commands/install-scripts
  - /cli/cli-commands/npm-install-scripts
  - /cli/commands/install-scripts
  - /cli/commands/npm-install-scripts
  - /cli/install-scripts
  - /cli/npm-install-scripts
  - /cli/v12/cli-commands/install-scripts
  - /cli/v12/cli-commands/npm-install-scripts
  - /cli/v12/commands/install-scripts
  - /cli/v12/install-scripts
  - /cli/v12/npm-install-scripts
  - /commands/install-scripts
  - /commands/npm-install-scripts
---
...
The standalone commands [`npm approve-scripts`](/cli/v12/commands/npm-approve-scripts) and [`npm deny-scripts`](/cli/v12/commands/npm-deny-scripts) are aliases for `npm install-scripts approve` and `npm install-scripts deny`.
...
- [npm approve-scripts](/cli/v12/commands/npm-approve-scripts)
