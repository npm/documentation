...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/npm-outdated
  - /cli-documentation/v12/cli-commands/outdated
  - /cli-documentation/v12/commands/npm-outdated
  - /cli-documentation/v12/commands/outdated
  - /cli-documentation/v12/npm-outdated
  - /cli-documentation/v12/outdated
  ...
  - /cli/npm-outdated
  - /cli/outdated
  - /cli/v12/cli-commands/npm-outdated
  - /cli/v12/cli-commands/outdated
  - /cli/v12/commands/outdated
  - /cli/v12/npm-outdated
  - /cli/v12/outdated
...
- `wanted` is the maximum version of the package that satisfies the semver range specified in `package.json`. If there's no available semver range (i.e. you're running `npm outdated --global`, or the package isn't included in `package.json`), then `wanted` shows the latest version.
- `latest` is the version of the package tagged as latest in the registry. Running `npm publish` with no special configuration will publish the package with a dist-tag of `latest`. This may or may not be the maximum version of the package, or the most-recently published version of the package, depending on how the package's developer manages the latest [dist-tag](/cli/v12/commands/npm-dist-tag).
