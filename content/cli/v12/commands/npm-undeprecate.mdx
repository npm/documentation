...
redirect_from:
  ...
  - /cli-documentation/v12/cli-commands/npm-undeprecate
  - /cli-documentation/v12/cli-commands/undeprecate
  - /cli-documentation/v12/commands/npm-undeprecate
  - /cli-documentation/v12/commands/undeprecate
  - /cli-documentation/v12/npm-undeprecate
  - /cli-documentation/v12/undeprecate
  ...
  - /cli/npm-undeprecate
  - /cli/undeprecate
  - /cli/v12/cli-commands/npm-undeprecate
  - /cli/v12/cli-commands/undeprecate
  - /cli/v12/commands/undeprecate
  - /cli/v12/npm-undeprecate
  - /cli/v12/undeprecate
...
It works in the same way as [npm deprecate](/cli/v12/commands/npm-deprecate), except that this command removes deprecation warnings instead of adding them.
