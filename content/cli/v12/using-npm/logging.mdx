...
redirect_from:
  ...
  - /cli-documentation/v12/misc/logging
  - /cli-documentation/v12/using-npm/logging
  - /cli/misc/logging
  - /cli/using-npm/logging
  - /cli/v12/misc/logging
  - /misc/logging
  - /using-npm/logging
---
...
The [`--timing` config](/cli/v12/using-npm/config#timing) can be set which does a few things:
