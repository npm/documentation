...
redirect_from:
  ...
  - /cli-documentation/v12/misc/removal
  - /cli-documentation/v12/misc/removing-npm
  - /cli-documentation/v12/using-npm/removal
  - /cli-documentation/v12/using-npm/removing-npm
  - /cli/misc/removal
  - /cli/misc/removing-npm
  - /cli/using-npm/removal
  - /cli/using-npm/removing-npm
  - /cli/v12/misc/removal
  - /cli/v12/misc/removing-npm
  - /cli/v12/using-npm/removing-npm
  - /misc/removal
  - /misc/removing-npm
  - /using-npm/removal
