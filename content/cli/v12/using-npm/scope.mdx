...
redirect_from:
  ...
  - /cli-documentation/v12/misc/npm-scope
  - /cli-documentation/v12/misc/scope
  - /cli-documentation/v12/using-npm/npm-scope
  - /cli-documentation/v12/using-npm/scope
  - /cli/misc/npm-scope
  - /cli/misc/scope
  - /cli/using-npm/npm-scope
  - /cli/using-npm/scope
  - /cli/v12/misc/npm-scope
  - /cli/v12/misc/scope
  - /cli/v12/using-npm/npm-scope
  - /misc/npm-scope
  - /misc/scope
  - /using-npm/npm-scope
  - /using-npm/scope
...
Note that if the `@` symbol is omitted, in either case, npm will instead attempt to install from GitHub; see [`npm install`](/cli/v12/commands/npm-install).
