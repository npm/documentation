...
redirect_from:
  ...
  - /cli-documentation/v12/misc/dependency-selectors
  - /cli-documentation/v12/using-npm/dependency-selectors
  - /cli/misc/dependency-selectors
  - /cli/using-npm/dependency-selectors
  - /cli/v12/misc/dependency-selectors
...
The [`npm query`](/cli/v12/commands/npm-query) command exposes a new dependency selector syntax (informed by & respecting many aspects of the [CSS Selectors 4 Spec](https://dev.w3.org/csswg/selectors4/#relational)) which:
...
- [npm query](/cli/v12/commands/npm-query)
