...
See [npmrc](/cli/v9/configuring-npm/npmrc) for more information about the npmrc files.

See [config](/cli/v9/using-npm/config) for a more thorough explanation of the mechanisms involved, and a full list of config options available.
