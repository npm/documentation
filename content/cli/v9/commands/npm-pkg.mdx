...
You can set/get/delete items across your configured workspaces by using the [`workspace`](/cli/v9/using-npm/config#workspace) or [`workspaces`](/cli/v9/using-npm/config#workspaces) config options.
