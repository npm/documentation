...
See [package-lock.json](/cli/v9/configuring-npm/package-lock-json) and
...
* `npm install` (in a package directory, no arguments):
    ...
    dependencies in [`package.json`](/cli/v9/configuring-npm/package-json).
...
* `npm install <tarball file>`:
    ...
    easily by using [`npm link`](/cli/v9/commands/npm-link).
...
* `npm install [<@scope>/]<name>`:
    ...
    [`config`](/cli/v9/using-npm/config#tag). The config's default value is `latest`.)
...
See the [`config`](/cli/v9/using-npm/config) help doc.  Many of the configuration
...
See [folders](/cli/v9/configuring-npm/folders) for a more detailed description of
