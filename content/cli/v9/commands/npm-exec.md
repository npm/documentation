...
You may use the [`workspace`](/cli/v9/using-npm/config#workspace) or
...
[`workspaces` config options](/cli/v9/using-npm/config#workspace), in this example
...
cli uses this cache. See [`npm cache`](/cli/v9/commands/npm-cache) for more on
how the cache works.
