...
redirect_from:
  - /cli-documentation/v9/ci
  - /cli-documentation/v9/cli-commands/ci
  - /cli-documentation/v9/cli-commands/npm-ci
  - /cli-documentation/v9/commands/ci
  - /cli-documentation/v9/commands/npm-ci
  - /cli-documentation/v9/npm-ci
  - /cli/v9/ci
  - /cli/v9/cli-commands/ci
  - /cli/v9/cli-commands/npm-ci
  - /cli/v9/commands/ci
  - /cli/v9/npm-ci
---
...
This command is similar to [`npm install`](/cli/v9/commands/npm-install), except it's meant to be used in automated environments such as test platforms, continuous integration, and deployment -- or any situation where you want to make sure you're doing a clean install of your dependencies.
