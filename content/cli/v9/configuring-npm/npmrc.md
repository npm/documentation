...
redirect_from:
  - /cli-documentation/v9/configuring-npm/npmrc
  - /cli-documentation/v9/files/npmrc
  - /cli/v9/files/npmrc
---
...
For a list of available configuration options, see [config](/cli/v9/using-npm/config).
