...
See [`package.json`](/cli/v9/configuring-npm/package-json) for details about what
...
* scripts: If you have a special compilation or installation script, then
  ...
  [scripts](/cli/v9/using-npm/scripts).
...
init`](/cli/v9/commands/npm-init) for more info.
