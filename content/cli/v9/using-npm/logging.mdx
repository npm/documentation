...
redirect_from:
  - /cli-documentation/v9/misc/logging
  - /cli-documentation/v9/using-npm/logging
  - /cli/v9/misc/logging
---
...
The [`--timing` config](/cli/v9/using-npm/config#timing) can be set which does a few things:
