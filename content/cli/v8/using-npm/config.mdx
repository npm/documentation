...
The location of npm's cache directory. See [`npm cache`](/cli/v8/commands/npm-cache)
...
A module that will be loaded by the `npm init` command. See the documentation for the [init-package-json](https://github.com/npm/init-package-json) module for more information, or [npm init](/cli/v8/commands/npm-init).
...
The location of npm's log directory. See [`npm logging`](/cli/v8/using-npm/logging) for more information.
