...
redirect_from:
  ...
  - /cli-documentation/v11/cli-commands/install-scripts
  - /cli-documentation/v11/cli-commands/npm-install-scripts
  - /cli-documentation/v11/commands/install-scripts
  - /cli-documentation/v11/commands/npm-install-scripts
  - /cli-documentation/v11/install-scripts
  - /cli-documentation/v11/npm-install-scripts
  ...
  - /cli/v11/cli-commands/install-scripts
  - /cli/v11/cli-commands/npm-install-scripts
  - /cli/v11/commands/install-scripts
  - /cli/v11/install-scripts
  - /cli/v11/npm-install-scripts
...
The standalone commands [`npm approve-scripts`](/cli/v11/commands/npm-approve-scripts) and [`npm deny-scripts`](/cli/v11/commands/npm-deny-scripts) are aliases for `npm install-scripts approve` and `npm install-scripts deny`.
...
- [npm approve-scripts](/cli/v11/commands/npm-approve-scripts)
- [npm deny-scripts](/cli/v11/commands/npm-deny-scripts)
