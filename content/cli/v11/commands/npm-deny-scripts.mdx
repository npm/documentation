...
redirect_from:
  ...
  - /cli-documentation/v11/cli-commands/deny-scripts
  - /cli-documentation/v11/cli-commands/npm-deny-scripts
  - /cli-documentation/v11/commands/deny-scripts
  - /cli-documentation/v11/commands/npm-deny-scripts
  - /cli-documentation/v11/deny-scripts
  - /cli-documentation/v11/npm-deny-scripts
  ...
  - /cli/v11/cli-commands/deny-scripts
  - /cli/v11/cli-commands/npm-deny-scripts
  - /cli/v11/commands/deny-scripts
  - /cli/v11/deny-scripts
  - /cli/v11/npm-deny-scripts
...
The companion command to [`npm approve-scripts`](/cli/v11/commands/npm-approve-scripts). Writes `false` entries into the `allowScripts` field of your project's `package.json`, recording that a dependency must not run install scripts even if a future version would otherwise be eligible.
