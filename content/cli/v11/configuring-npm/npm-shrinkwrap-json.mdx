...
redirect_from:
  - /cli-documentation/v11/configuring-npm/npm-shrinkwrap-json
  - /cli-documentation/v11/configuring-npm/npm-shrinkwrap.json
  - /cli-documentation/v11/files/npm-shrinkwrap-json
  - /cli-documentation/v11/files/npm-shrinkwrap.json
  - /cli/v11/configuring-npm/npm-shrinkwrap.json
  - /cli/v11/files/npm-shrinkwrap-json
  - /cli/v11/files/npm-shrinkwrap.json
---

### Description

`npm-shrinkwrap.json` is a file created by [`npm shrinkwrap`](/cli/v11/commands/npm-shrinkwrap). It is identical to `package-lock.json`, with one major caveat: Unlike `package-lock.json`, `npm-shrinkwrap.json` may be included when publishing a package.
...
For full details and description of the `npm-shrinkwrap.json` file format, refer to the manual page for [package-lock.json](/cli/v11/configuring-npm/package-lock-json).
