...
redirect_from:
  - /cli-documentation/v11/misc/dependency-selectors
  - /cli-documentation/v11/using-npm/dependency-selectors
  - /cli/v11/misc/dependency-selectors
---

### Description

The [`npm query`](/cli/v11/commands/npm-query) command exposes a new dependency selector syntax (informed by & respecting many aspects of the [CSS Selectors 4 Spec](https://dev.w3.org/csswg/selectors4/#relational)) which:
...
- [npm query](/cli/v11/commands/npm-query)
