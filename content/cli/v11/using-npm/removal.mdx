...
redirect_from:
  - /cli-documentation/v11/misc/removal
  - /cli-documentation/v11/misc/removing-npm
  - /cli-documentation/v11/using-npm/removal
  - /cli-documentation/v11/using-npm/removing-npm
  - /cli/v11/misc/removal
  - /cli/v11/misc/removing-npm
  - /cli/v11/using-npm/removing-npm
---
