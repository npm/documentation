...
redirect_from:
  - /cli-documentation/v11/misc/scripts
  - /cli-documentation/v11/using-npm/scripts
  - /cli/v11/misc/scripts
---
...
#### [`npm cache add`](/cli/v11/commands/npm-cache)
...
#### [`npm diff`](/cli/v11/commands/npm-diff)
...
#### [`npm run <user defined>`](/cli/v11/commands/npm-run)
...
#### A Note on a lack of [`npm uninstall`](/cli/v11/commands/npm-uninstall) scripts
...
See [`package.json`](/cli/v11/configuring-npm/package-json) for more on package configs.
