...
redirect_from:
  - /cli-documentation/v11/misc/npm-scope
  - /cli-documentation/v11/misc/scope
  - /cli-documentation/v11/using-npm/npm-scope
  - /cli-documentation/v11/using-npm/scope
  - /cli/v11/misc/npm-scope
  - /cli/v11/misc/scope
  - /cli/v11/using-npm/npm-scope
---
...
Note that if the `@` symbol is omitted, in either case, npm will instead attempt to install from GitHub; see [`npm install`](/cli/v11/commands/npm-install).
