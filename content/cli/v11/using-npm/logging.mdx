...
redirect_from:
  - /cli-documentation/v11/misc/logging
  - /cli-documentation/v11/using-npm/logging
  - /cli/v11/misc/logging
---
...
The [`--timing` config](/cli/v11/using-npm/config#timing) can be set which does a few things:
