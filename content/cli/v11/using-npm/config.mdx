...
redirect_from:
  - /cli-documentation/v11/misc/config
  - /cli-documentation/v11/using-npm/config
  - /cli/v11/misc/config
---

### Description

This article details npm configuration in general. To learn about the `config` command, see [`npm config`](/cli/v11/commands/npm-config).
...
See [npmrc](/cli/v11/configuring-npm/npmrc) for more details.
...
The location of npm's log directory. See [`npm logging`](/cli/v11/using-npm/logging) for more information.
