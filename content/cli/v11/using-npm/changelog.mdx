...
redirect_from:
  ...
  - /cli-documentation/v11/misc/changelog
  - /cli-documentation/v11/using-npm/changelog
  - /cli/misc/changelog
  - /cli/using-npm/changelog
  - /cli/v11/misc/changelog
  - /misc/changelog
  - /using-npm/changelog
---
...
- Upon publishing a package, in order to apply a default "latest" dist tag, the command now retrieves all prior versions of the package and requires  the version that you're trying to publish to be above the latest semver version in the registry, excluding pre-release tags.
- `npm init` now sorts the entries of the created packages by importance and relevnace, also a `type` prompt is added.
