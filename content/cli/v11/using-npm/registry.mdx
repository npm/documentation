...
redirect_from:
  - /cli-documentation/v11/misc/registry
  - /cli-documentation/v11/using-npm/registry
  - /cli/v11/misc/registry
---
...
See [`package.json`](/cli/v11/configuring-npm/package-json) for more info on what goes in the package.json file.
