...
- When **bypass 2FA is enabled**: The token will bypass 2FA requirements for publishing and other package write actions, regardless of account-level or package-level 2FA settings
