...
- The package can be **brand-new or already published** — staging a package that doesn't yet exist on the npm registry creates it when the staged version is approved
