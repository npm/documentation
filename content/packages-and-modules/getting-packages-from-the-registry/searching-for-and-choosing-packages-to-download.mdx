...
4. The package homepage also displays provenance information when available. For details on how to verify it check [viewing package provenance](/viewing-package-provenance)
