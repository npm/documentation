...
CI/CD workflows can also manage dist-tags with [trusted publishing](/trusted-publishers#managing-dist-tags-with-trusted-publishing). Enable **Allow npm dist-tag** for the workflow's trusted publisher configuration. This permission is disabled by default and is separate from direct-publish permission.
