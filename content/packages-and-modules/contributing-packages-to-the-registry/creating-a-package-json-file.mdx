...
> npm set init-license "MIT"example-user@example.comhttps://gitlab.com/gitlab-org/gitlab-foss.gitgdk install gitlab_repo=https://gitlab.com/gitlab-org/gitlab-foss.gitgit@gitlab.comgdk install gitlab_repo=git@gitlab.com:gitlab-org/gitlab-foss.gitexport GITLAB_LICENSE_MODE=test
export CUSTOMER_PORTAL_URL=https://customers.staging.gitlab.comhttps://customers.staging.gitlab.comgdk config set license.customer_portal_url <customer portal url>
