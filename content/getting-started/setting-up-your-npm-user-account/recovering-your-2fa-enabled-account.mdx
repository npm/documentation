...
4. Enter an unused recovery code in the "Use a Recovery Code" prompt.
   ...
   <Screenshot src="/getting-started/setting-up-your-npm-user-account/use-a-recovery-code.png" alt="Screenshot showing use a recovery code prompt with an input box to enter the recovery code" />
