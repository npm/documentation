...
Account-identity actions — changing your email or password, modifying your 2FA configuration, viewing or generating recovery codes, creating or escalating tokens, and adding or removing maintainers — always require an interactive 2FA challenge and cannot be performed with a bypass-2FA token.
