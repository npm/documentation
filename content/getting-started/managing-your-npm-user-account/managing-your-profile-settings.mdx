...
To enable, configure, and disable two-factor authentication from the command line, see "[配置双重验证](/configuring-two-factor-authentication#configuring-2fa-from-the-command-line)".
