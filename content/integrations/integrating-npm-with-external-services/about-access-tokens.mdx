...
Publish
A publish token can read and publish packages to the npm registry. If you have two-factor authentication (2FA) enabled, it will be required when using this token.        ---
