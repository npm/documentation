...
To set your `NPM_TOKEN` environment varible run `export NPM_TOKEN="00000000-0000-0000-0000-000000000000"` and pass your npm access token instead of `0`s.

<Note>
  
**Note:** After setting your `NPM_TOKEN` environment variable remember to clean your terminal history. You can do it with `history -c` command for `bash` and `history -p` for `zsh`.
