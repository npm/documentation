...
-   Services that assist with the detection of spam, scams, abuse
    others, or other violations of our [terms of service](https://docs.npmjs.com/terms)
...
require you to [license npm to share it](https://docs.npmjs.com/open-source-terms#your-content).
...
npm's [unpublish policy](https://docs.npmjs.com/unpublish)
...
Please see [our policy on "unpublishing" packages](https://docs.npmjs.com/unpublish) or
[our terms of service](https://docs.npmjs.com/open-source-terms) for more
...
service](https://docs.npmjs.com/open-source-terms).
...
[https://docs.npmjs.com/privacy](https://docs.npmjs.com/privacy),
