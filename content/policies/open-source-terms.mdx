...
-  Additional terms for npm Paid Services are available at
   <https://docs.npmjs.com/private-terms>.
...
<https://docs.npmjs.com/privacy> (the _Privacy Policy_)
...
1.  You will abide by the
    [Code of Conduct](https://docs.npmjs.com/conduct) and the
    [Dispute Policy](https://docs.npmjs.com/disputes).
...
from npm, our Paid Services Terms at <https://docs.npmjs.com/private-terms>
apply.
