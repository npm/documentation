...
to the terms described in the [Disputes Policy](https://docs.npmjs.com/disputes).
...
rules including its
[Acceptable Content](https://docs.npmjs.com/open-source-terms#acceptable-use)
...
* If you have concerns about a potential copyright violation,
  please refer to our [Copyright Policy](https://docs.npmjs.com/dmca)
...
* If you think a package or other content is "squatting" on a name,
  ...
  [Disputes Policy](https://docs.npmjs.com/disputes).
